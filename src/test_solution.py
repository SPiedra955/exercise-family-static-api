...
def test_first_three(client):
    ...
    assert len(
        members) == 3, "The Family structure must be initialized with the 3 members specified in the instructions"
...
def test_get_members_returns_list(client):
    ...
    assert isinstance(
        data, list), "The GET /members method should return a list"
...
@pytest.mark.it("After deleting the member 5 we called GET /members and it should return a list with 4 members")
